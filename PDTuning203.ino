...
const byte SIGNAL_L_A = 9;  //right
const byte SIGNAL_L_B = 10; //right
const byte SIGNAL_R_A = 11; //left
const byte SIGNAL_R_B = 12; //left
...
void loop() {
  ...
  //checkIMU();
  calcError(1, 0);
  u_L = PI_controller(e_L, e_sum_L, 250, 0);
  Serial.print("PWM Left: ");
  Serial.print(u_L);
  u_R = PI_controller(e_R, e_sum_R, 250, 0);
